  ...
  await prisma.modelEvaluationRun.create({
    data: {
      ...
      configJson: JSON.stringify({
        ...
        candidateSelection: "six predeclared candidates, block-bootstrap interval, deflated Sharpe, four-period stability, and same-period best-of-four benchmark excess",
