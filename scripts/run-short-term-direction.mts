...
const strategyConfig: Partial<CombinedShadowConfig> = {
  ...
  modelVersion: "Short Direction v9 2026-07-18 / near-term market discovery / all sources fresh within 15s / persisted synchronized 5s signal / causal 5s execution audit / Chainlink boundary reconciliation / independent 15m windows / 11 trials / entry 2-4m / p 0.58 / spread 0.08 / no backfill",
};
...
const controlConfig: Partial<CombinedShadowConfig> = {
  ...
  modelVersion: "Short Direction Control v9 2026-07-18 / near-term market discovery / all sources fresh within 15s / persisted synchronized 5s signal / causal 5s execution audit / Chainlink boundary reconciliation / independent 15m windows / 11 trials / entry 2-4m / p 0.58 / spread 0.08 / no backfill",
};
