...
def import_forward_execution_audits(args):
    ...
    for report_path in sorted(artifact_dir.glob("*/report.json")):
        ...
        candidates = {
            ...
            "settlement_rtds_reconstructed_markets": settlement.get("reconstructedCompleteMarkets"),
            "settlement_rtds_direction_mismatches": settlement.get("reconstructedMismatchedMarkets"),
            "settlement_rtds_direction_match_rate": settlement.get("reconstructionMatchRate"),
            "settlement_rtds_open_basis_bps_median_abs": settlement.get("medianAbsoluteOpenPriceBasisBps"),
            "settlement_rtds_close_basis_bps_median_abs": settlement.get("medianAbsoluteClosePriceBasisBps"),
